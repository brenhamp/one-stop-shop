...
In the future, we'd like to implement login using [Passport](https://www.passportjs.org/) and [passport-github](https://www.npmjs.com/package/passport-githubhttps://www.npmjs.com/package/passport-github). This would allow users to use their GitHub credentials on the site. We'd also like to add a checkout feature that tells users their order has been placed and clears their cart. And in general, more products and departments would make the site 
