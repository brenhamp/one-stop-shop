...
In the future, we'd like to implement login using Passport. This would allow users to use their GitHub credentials on the site. We'd also like to add a checkout feature that tells 
